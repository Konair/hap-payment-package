...
use Konair\HAP\Payment\Application\Command\Cart\ModifyBuyer\ModifyBuyerRequest;
use Konair\HAP\Payment\Application\Command\Cart\ModifyBuyer\ModifyBuyerService;
...
final class ModifyBuyerController
{
    use CartResponse;
    ...
    public function __invoke(string|null $cartId, Request $httpRequest): Response
    {
        ...
        $request = new ModifyBuyerRequest($cartId, $httpRequest->get('buyerId'));
        $service = new ModifyBuyerService($this->cartRepository);
